# libiox Test Suite Coverage

## Overview

Comprehensive XCTest-based test suite for the libiox iOS Subsystem for Linux.
Total: **73 syscalls tested** across **10 test files** (~80KB of test code)

## Test Infrastructure

### Core Test Helpers
- **IOXTestHelpers.h/mm** - Memory tracking, test environment setup, library state management
...
### 1. Process Management Tests (IOXProcessTests.mm)
**16 syscalls** | 9.5KB
...
### 2. File Operations Tests (IOXFileTests.mm)
**20 syscalls** | 12.0KB
- ✓ open, openat
- ✓ creat
- ✓ read, write
...
### 3. Filesystem Tests (IOXFilesystemTests.mm)
**13 syscalls** | 8.4KB
- ✓ stat, fstat, lstat
- ✓ mkdir, rmdir
- ✓ unlink
...
### 4. Environment Tests (IOXEnvironmentTests.mm)
**5 syscalls** | 5.1KB
- ✓ getenv
- ✓ setenv
- ✓ unsetenv
...
### 5. Signal Tests (IOXSignalTests.mm)
**5 syscalls** | 5.8KB
- ✓ signal
- ✓ kill
- ✓ sigaction
...
### 6. Memory Tests (IOXMemoryTests.mm)
**3 syscalls** | ~8KB
...
### 9. Network Stub Tests (IOXNetworkStubTests.mm)
**20+ syscalls** | ~9KB
...
- Leak detection assertions (`IOXAssertNoMemoryLeak`)
...
- Xcode 15.0+
- iOS 16.0+ Simulator
- libiox static library (libiox-sim.a)

### Build Steps
1. Build libiox for iOS Simulator:
   ```bash
...
2. Open Xcode project:
   ```bash
   open ios-test-app/IOXTestSuite/IOXTestSuite.xcodeproj
   ```
...
```
IOXTestSuiteTests/
├── IOXTestHelpers.h/.mm      # Test infrastructure
├── IOXProcessTests.mm        # Process management
├── IOXFileTests.mm           # File operations
├── IOXFilesystemTests.mm     # Filesystem operations
├── IOXEnvironmentTests.mm    # Environment variables
├── IOXSignalTests.mm         # Signal handling
├── IOXMemoryTests.mm         # Memory management
├── IOXTimeTests.mm           # Time functions
├── IOXTtyTests.mm            # TTY operations
└── IOXNetworkStubTests.mm    # Network stubs
```
