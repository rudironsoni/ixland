...
# Build libiox test app and run on iOS Simulator
#
...
echo "========================================"
echo "Building libiox Test for iOS Simulator"
echo "========================================"
echo ""
echo "SDK: $SIM_SDK"
echo "Target: $TARGET"
...
if [ ! -f "../libiox-sim.a" ]; then
    echo "Error: libiox-sim.a not found in parent directory"
...
# Show iox symbols
echo ""
echo "libiox symbols in executable:"
nm "build/$APP_NAME.app/$APP_NAME" 2>/dev/null | grep -E "T iox_" | head -10 || echo "Symbols stripped or not found"
...
echo "5. Add libiox-sim.a and libiwasm.a to project"
