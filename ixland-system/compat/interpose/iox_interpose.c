...
__attribute__((visibility("default"))) int sigaction(int s, const struct sigaction *a, struct sigaction *o) { 
...
/* Memory stubs */
__attribute__((visibility("default"))) void *mmap(void *a, size_t l, int p, int f, int fd, off_t o) { 
