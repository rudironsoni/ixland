...
__thread char	**CONVFMT;	/* format for conversions in getsval */
...
__thread Cell	*fsloc;		/* FS */
__thread Cell	*nrloc;		/* NR */
__thread Cell	*nfloc;		/* NF */
__thread Cell	*fnrloc;	/* FNR */
__thread Cell	*ofsloc;	/* OFS */
__thread Cell	*orsloc;	/* ORS */
__thread Cell	*rsloc;		/* RS */
__thread Array	*ARGVtab;	/* symbol table containing ARGV[...] */
__thread Array	*ENVtab;	/* symbol table containing ENVIRON[...] */
__thread Cell	*rstartloc;	/* RSTART */
__thread Cell	*rlengthloc;	/* RLENGTH */
__thread Cell	*subseploc;	/* SUBSEP */
__thread Cell	*symtabloc;	/* SYMTAB */

__thread Cell	*nullloc;	/* a guaranteed empty cell */
...
// iOS additions: clean up symbol tables
void clearsymtab(Array* table) {
    free(table->tab);
    table->tab = 0;
    table->size = 0;
    table->nelem = 0;
