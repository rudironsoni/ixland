 ...
 */
int iox_sigaction(int signum, const struct iox_sigaction *act,
                  struct iox_sigaction *oldact);
 ...
 * @return int 0 on success, -1 on error
 */
int iox_sigaltstack(const struct iox_sigaltstack *ss,
                    struct iox_sigaltstack *oldss);
 ...
 * @return int 0 on success, -1 on error
 */
int iox_sigorset(iox_sigset_t *dest, const iox_sigset_t *left,
                 const iox_sigset_t *right);
 ...
 * @return int 0 on success, -1 on error
 */
int iox_sigandset(iox_sigset_t *dest, const iox_sigset_t *left,
                  const iox_sigset_t *right);
