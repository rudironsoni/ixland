 ...
 * @return int 0 on success, -1 on error
 */
int iox_prlimit(pid_t pid, int resource,
 ...
 * @return int 0 on success, -1 on error
 */
int iox_prlimit64(pid_t pid, int resource,
...
#define IOX_IOPRIO_PRIO_VALUE(class, data) \
    (((class) << IOX_IOPRIO_CLASS_SHIFT) | (data))
