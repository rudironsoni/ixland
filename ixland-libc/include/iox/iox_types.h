...
/**
 * @brief iox error codes enumeration
 *
...
/**
 * @brief iox library configuration structure
 *
 * Used to configure the iox library behavior on initialization.
 * Pass a pointer to this structure to iox_init().
 */
typedef struct {
 ...
 *
 * Contains information about a process in the iox system.
 * Use iox_get_proc_info() to retrieve this information.
 */
typedef struct {
 ...
 *
 * Contains information about a thread in the iox system.
 * Use iox_get_thread_info() to retrieve this information.
 */
typedef struct {
 ...
 * Use iox_get_sys_info() to retrieve this information.
 */
typedef struct {
 ...
 * @param event Event type (IOX_PROC_*)
 ...
 * @param event Event type (IOX_THREAD_*)
 * @param userdata User data passed when registering callback
 */
 ...
 * @param op Operation type (IOX_FILE_*)
 * @param userdata User data passed when registering callback
 */
